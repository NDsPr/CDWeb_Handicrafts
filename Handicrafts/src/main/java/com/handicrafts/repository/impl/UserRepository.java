...
public class UserRepository {
    public List<UserDTO> findAllAccounts() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                userDTO.setRoles((List<String>) resultSet.getObject("roleId"));                userDTO.setEmail(resultSet.getString("email"));
               userDTO.setStatus(resultSet.getBoolean("status"));
                userDTO.setCreatedAt(resultSet.getTimestamp("createdDate"));
                userDTO.setUpdatedAt(resultSet.getTimestamp("modifiedDate"));
    ...
    public int createAccount(UserDTO userDTO) {
        ...
        try {
            ...
            SetParameterUtil.setParameter(preparedStatement, userDTO.getPassword(),
                     userDTO.getRoles(), userDTO.getEmail(),
                   userDTO.getStatus());
    ...
    public UserDTO findUserById(int id) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                userDTO.setRoles((List<String>) resultSet.getObject("roleId"));
                userDTO.setStatus(resultSet.getBoolean("status"));
                userDTO.setCreatedAt(resultSet.getTimestamp("createdDate"));
            }
        } catch (SQLException e) {
    ...
    public int createInRegister(UserDTO user) {
        int id = -1;
        StringBuilder sql = new StringBuilder();
        ...
        try {
            ...
            SetParameterUtil.setParameter(preparedStatement, user.getEmail(), user.getPassword());
    ...
    public int createOAuth(UserDTO user, String platform) {
        int id = -1;
        StringBuilder sql = new StringBuilder();
        sql.append("INSERT INTO users ")
    ...
    public int updateAccount(UserDTO user) {
        ...
        try {
            ...
            connection.setAutoCommit(false);
            preparedStatement = connection.prepareStatement(sql.toString());
            SetParameterUtil.setParameter(preparedStatement,user.getId());
    ...
    // Lấy lên thông tin của User và gán vào UserDTO
    ...
    // Cập nhật lại thông tin tài khoản
    public void updateAccountForAdmin(UserDTO user) {
        StringBuilder sql = new StringBuilder();
        sql.append("UPDATE users ")
        ...
        try {
            ...
            connection.setAutoCommit(false);
            preparedStatement = connection.prepareStatement(sql.toString());
            SetParameterUtil.setParameter(preparedStatement, user.getRoles(), user.getStatus(), user.getId());
            preparedStatement.executeUpdate();
            connection.commit();
        } catch (SQLException e) {
            try {
    ...
    public List<UserDTO> getUsersDatatable(int start, int length, String columnOrder, String orderDir, String searchValue) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                user.setRoles((List<String>) rs.getObject("roleId"));
                user.setStatus(rs.getBoolean("status"));
               user.setCreatedAt(rs.getTimestamp("createdDate"));
    ...
    public UserDTO findUserByOrderId(int orderId) {
